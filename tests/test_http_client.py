...
from jellyswipe.http_client import make_http_request, DEFAULT_USER_AGENT, DEFAULT_TIMEOUT
...
class TestMakeHttpRequest:
    ...
    def test_make_http_request_get_method(self):
        ...
        with patch('jellyswipe.http_client.requests.request') as mock_request:
            ...
            response = make_http_request(method='GET', url='https://api.example.com/test')
...
import logging  # Ensure logging is imported for caplog to work